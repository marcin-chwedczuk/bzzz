...
public class Xor extends BaseElement {
    ...
    public Xor(Simulator simulator, ComponentId componentId) {
        ...
        scheduleInitialization(() -> {
            ...
            LogicState outputLS = ttlXor(input1LS, input2LS);
    ...
    private LogicState ttlXor(LogicState input1LS, LogicState input2LS) {
        return (input1LS.toTTL() == input2LS.toTTL())
                ? LogicState.ZERO
                : LogicState.ONE;
    }
}
