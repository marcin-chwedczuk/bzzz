...
public class Nor4 extends BaseElement {
    ...
    public Nor4(Simulator simulator, ComponentId componentId) {
        ...
        scheduleInitialization(() -> {
            ...
            LogicState outputLS = ttlNor(input1LS, input2LS, input3LS, input4LS);
